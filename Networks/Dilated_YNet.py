...
class DoubleConv_2d(nn.Sequential):
    def __init__(self, in_channels, out_channels, mid_channels=None):
        ...
        super(DoubleConv_2d, self).__init__(
            ...
            nn.Conv2d(mid_channels, out_channels, kernel_size=3, stride=1, padding=3, bias=False, dilation=3),
...
class Dilated_Y_Net(nn.Module):
    def __init__(self,
        ...
        super(Dilated_Y_Net, self).__init__()
